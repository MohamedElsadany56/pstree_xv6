...
#define COLOR_UNUSED   "\x1b[90m"   // Bright black (gray)
#define COLOR_USED     "\x1b[37m"   // White
#define COLOR_SLEEPING "\x1b[34m"   // Blue
#define COLOR_RUNNABLE "\x1b[33m"   // Yellow
#define COLOR_RUNNING  "\x1b[32m"   // Green
#define COLOR_ZOMBIE   "\x1b[31m"   // Red
